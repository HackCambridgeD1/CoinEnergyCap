...
TREES_PER_KG_CO2 = 6 / 1000


def num_trees_to_offset_co2_amount(kg_co2: float):
    return kg_co2 * TREES_PER_KG_CO2


LITRES_PER_100KM = 7
EARTH_CIRCUMFERENCE_KM = 40000
DENSITY_OF_OIL = 0.85  # DIESEL 0.85t/m^3


def tons_oil_to_earth_circumventions(tons_of_oil: float):
    cubicmetres_of_oil = tons_of_oil / DENSITY_OF_OIL
